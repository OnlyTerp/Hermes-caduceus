...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("caduceus", "Toggle Caduceus deep-planning mode (live to-do list + methodical execution; say \"workflow\" to fan out)",
               "Configuration", aliases=("cad", "uc"), cli_only=True,
               args_hint="[on|off|status|auto on|off]",
               subcommands=("on", "off", "status", "auto")),
    CommandDef("local", "Run Caduceus workflow workers on local GPU models (hot-swap + capacity-aware parallelism)",
               "Configuration", aliases=("loc",), cli_only=True,
