...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("caduceus", "Toggle Caduceus dynamic-workflow mode (xhigh effort + standing Workflow opt-in + orchestrator/worker tiers)",
               "Configuration", aliases=("cad", "uc"), cli_only=True,
               args_hint="[on|off|status|orch <model>|worker <model>|effort <level>|budget <tokens>]",
               subcommands=("on", "off", "status", "orch", "worker", "budget", "solo", "effort")),
